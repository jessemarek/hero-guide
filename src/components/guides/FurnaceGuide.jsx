    ...
    <div className="furnace-guide wrapper">
      <div id="overview" className="guide-section">
        ...
        <div className="intro-text">
          <p>
            The <b>Furnace</b> is part of the <b>Heroes' Village</b>. Once a
            player reaches Level 85 they are granted access to the Village and
            its buildings. The Furnace allows players to melt down excess
            equipment and{" "}
            <img
              ...
              height="16"
            />{" "}
            in exchange for Heroes' Village resources ({" "}
            <img
            ...
            <img
              ...
              height="16"
            />{" "}
            ). Melting down equipment gives a combination of all 3 resources,
            while melting down{" "}
            <img
              src="/assets/images/icons/hero-info/ss.png"
              alt=""
            ...
            <img
              ...
              height="16"
            />
            . Each item yields a different amount of resources when melted down.{" "}
            <img
              src="/assets/images/icons/hero-info/ss.png"
              alt=""
              width="16"
            ...
            <img
              ...
              height="16"
            />{" "}
            each. Melting down items requires{" "}
            <img
              src="/assets/images/icons/heroic-academy/resources/fuel.png"
              alt=""
              width="16"
              height="16"
            />
            , which replenishes over time. Melting down can "crit". When this
            occurs, one or more of the resources received from melting down an
            item may yield double the usual amount.
          </p>
          <p>
            Upgrading the Furnace reduces the amount of{" "}
            <img
              src="/assets/images/icons/heroic-academy/resources/fuel.png"
              alt=""
              width="16"
              height="16"
            />{" "}
            required to melt down items, increases maximum{" "}
            <img
              src="/assets/images/icons/heroic-academy/resources/fuel.png"
              alt=""
              width="16"
              height="16"
            />
            , and increases the variety of items available to melt down. While
            the building is being upgraded you will be unable to use its
        ...
        <div className="intro-text">
          <p>
            By the time you reach Level 85 and gain access to the Furnace,{" "}
            <span className="blu-txt">Blue</span> Items will be the best option
            to melt down to fill your{" "}
            <img
              src="/assets/images/icons/heroic-academy/resources/wood.png"
              alt=""
              width="16"
            ...
            <img
              ...
              height="16"
            />{" "}
            needs. <span className="blu-txt">Blue</span> Items are also very
            useful for using as Enchantment Materials for your Hero's Gear.{" "}
            <span className="blu-txt">Blue</span> Items can be easily stockpiled
            by completing all your daily tasks such as: Crucible of Fire runs,
            Campaign Sweeps/Farming and opening Gold Chests. Below is a chart of
            the 6 <span className="blu-txt">Blue</span> Items that produce the
            most{" "}
            <img
              src="/assets/images/icons/heroic-academy/resources/wood.png"
              alt=""
            ...
            <img
              ...
              height="16"
            />{" "}
            from melting. If you focus on melting these, you can use the others
            for your Enchanment needs.
          </p>
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <img
                        src="/assets/images/icons/equipment/runic-eulogy.png"
                        alt=""
                        width="36"
                        height="36"
                      />
                    ...
                    <td>
                      <img
                        src="/assets/images/icons/equipment/ritual-blade.png"
                        alt=""
                        width="36"
                        height="36"
                      />
                  ...
                  <tr>
                    ...
                    <td>
                      <img
                        src="/assets/images/icons/equipment/gem-of-vigor.png"
                        alt=""
                        width="36"
                        height="36"
                      />
      ...
      <div id="blue" className="guide-section">
        <div className="section-header">
          <h2>
            <span className="blu-txt">Blue Item</span> Melt Values
          </h2>
        </div>
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/strand-of-rejuvenation.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/meteor-flail.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/dragon's-fang.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/bloody-hatchet.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/scepter-of-prophecy.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/demonic-longsword.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/dwarvish-chestplate.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/charger-boots.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/bulwark-of-vitality.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/casket-of-time.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/hefty-war-axe.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/mask-of-sacrifice.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/emerald-cuirass.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/golden-mallet.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/skull-bonnet.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/warrior's-gloves.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/aurora-torch.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/black-dragon's-tailbone.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/wizardry-codex.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/gem-of-fortitude.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/cloud-walkers.png"
                      alt=""
                      width="36"
                      height="36"
                    />
      ...
      <div id="purple" className="guide-section">
        <div className="section-header">
          <h2>
            <span className="prp-txt">Purple Item</span> Melt Values
          </h2>
        </div>
      ...
      <div id="orange" className="guide-section">
        <div className="section-header">
          <h2>
            <span className="org-txt">Orange Item</span> Melt Values
          </h2>
        </div>
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/midnight-dream.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/gaia's-cutlass.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/victory's-scepter.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/blade-of-cataclysm.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/caduceus.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/atlantean-battleaxe.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/beastly-guardian.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/sword-of-olympus.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/angel's-wings.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/book-of-mysteries.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/aegis.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/angelic-fan.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/priestly-scepter.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/cosmic-shield.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/ares'-spear.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/armor-of-shadows.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/helira's-mask.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/shadow-slayer.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/demonic-visage.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/poseidon's-trident.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/thunderbolt.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/blade-of-time.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/underworld-saber.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/jewel-of-helios.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/renegade's-armor.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/demon's-skull.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/zealot-battleplate.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/fire-hardened-steel.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/kalerian-granite.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/transforming-mask.png"
                      alt=""
                      width="36"
                      height="36"
                    />
      ...
      <div id="red" className="guide-section">
        <div className="section-header">
          <h2>
            <span className="red-txt">Red Item</span> Melt Values
          </h2>
        </div>
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/tyrant's-helmet.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/master's-cap.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/widowmaker.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/sphere-of-the-sands.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/pure-jade-chest.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/hurricane-blade.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/songbird-ring.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/crescent-staff.png"
                      alt=""
                      width="36"
                      height="36"
                    />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/cloak-of-wisdom.png"
                      alt=""
                      width="36"
                      height="36"
                    />
                ...
                <tr>
                  <td>
                    <img
                      src="/assets/images/icons/equipment/paladin's-chestplate.png"
                      alt=""
                      width="36"
                      height="36"
                    />
