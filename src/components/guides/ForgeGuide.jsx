        ...
        <div className="wrapper">
            ...
            <section id="overview" className="guide-section">
                ...
                <div className="intro-text">
                    <p>The Forge is used to further enhance the Stats of Awakened Heroes. Once a player reaches Level 90 the Forge becomes available for use. It can only be used with Awakened Heroes, however, and will be of no use to the player until they complete their first Awakening Quest. Once a Hero is Awakened, the Forge can be used to boost the Stats of the Hero's Signature Item. Every Hero has 3 different Stats that may be boosted. Physical or Magic Attack, Physical Armor and Magic Armor. Once each of these Stats reaches a certain threshold, an additional Bonus Stat will be unlocked for that item. Once fully upgraded an Awakend Hero can receive the benefit of a total of 6 Bonus Stats from the Forging process.
        </p>
                </div>
                ...
                <div className="example-image-box">
                    ...
                    <div className="example-image">
                        <img src="/assets/images/icons/forge/forge-example2.jpg" width="300" alt="Screenshot of the Forge" /><p className="image-note">Forged Stats applied to Signature Item</p>
                    </div>

                    <div className="example-image">
                        <img src="/assets/images/icons/forge/forge-example1.jpg" width="300" alt="Screenshot of the Forge" /><p className="image-note">Example: Bonus Stats unlocked</p>
                    </div>
                ...
                <div id="forge-bonus-example" className="statbox">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>≥ 100</td>
                            <td>M. Attack</td>
                            <td><span className="grn-txt">+70</span></td>
                        </tr>
                        <tr>
                            <td>M. Armor</td>
                            <td>≥ 200</td>
                            <td>Max Health</td>
                            <td><span className="grn-txt">+2000</span></td>
                        </tr>
                    </table>
                </div>
                ...
                <div className="intro-text">
                    <p>As you can see in the examples, once the Magic Attack Stat gets forged to 40 or higher, the Physical Armor Bonus unlocks. Again, once the Physical Armor Stat reaches 100 the Magic Attack Bonus unlocks. The 3 Base Stats (P./M. Attack, P. Armor, M. Armor) can be forged to a max value of 200 once the Forge is fully upgraded, but the Bonus Stats will only be awarded at the listed value and cannot be increased.</p>
            ...
            <section id="upgrade" className="guide-section">
                ...
                <div className="intro-text">
                    <p>The Forge also requires you to Awaken a certain number of Heroes to upgarde to certain levels. Below is a table of the number of Heroes required for these levels.</p>
                </div>
