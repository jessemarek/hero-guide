    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/goblet-of-the-ancients.png" width="36" height="36" /><img src="/assets/images/icons/equipment/banshee-essence.png" width="36" height="36" /><img src="/assets/images/icons/equipment/skull-bonnet.png" width="36" height="36" /><p>Level 77 Required</p>
            </div>
        </div>
    )
}
