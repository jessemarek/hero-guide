    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/scepter-of-the-abyss.png" width="36" height="36" /><img src="/assets/images/icons/equipment/wellspring-water.png" width="36" height="36" /><p>Level 77 Required</p>
            </div>
        </div>
    )
}
