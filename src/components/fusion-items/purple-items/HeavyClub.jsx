    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/mask-of-sacrifice.png" width="36" height="36" /><img src="/assets/images/icons/equipment/cloud-walkers.png" width="36" height="36" /><p>Level 57 Required</p>
            </div>
        </div>
    )
}
