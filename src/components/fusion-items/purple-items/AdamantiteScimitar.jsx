    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/grim-slasher.png" width="36" height="36" /><img src="/assets/images/icons/equipment/golden-mallet.png" width="36" height="36" /><img src="/assets/images/icons/equipment/steel-sword.png" width="36" height="36" /><p>Level 70 Required</p>
            </div>
        </div>
    )
}
