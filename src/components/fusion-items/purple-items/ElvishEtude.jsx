    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/soothsayer-handwraps.png" width="36" height="36" alt="equipment icon" /><img src="/assets/images/icons/equipment/ritual-blade.png" width="36" height="36" alt="equipment icon" /><br /><img src="/assets/images/icons/equipment/hefty-war-axe.png" width="36" height="36" alt="equipment icon" /><img src="/assets/images/icons/equipment/giant's-girdle.png" width="36" height="36" alt="equipment icon" /><p>Level 63 Required</p>
            </div>
        </div>
    )
}
