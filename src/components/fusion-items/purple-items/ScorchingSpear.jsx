    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/mask-of-sacrifice.png" width="36" height="36" /><img src="/assets/images/icons/equipment/dragon's-fang.png" width="36" height="36" /><br></br><img src="/assets/images/icons/equipment/bloody-hatchet.png" width="36" height="36" /><img src="/assets/images/icons/equipment/aurora-torch.png" width="36" height="36" /><p>Level 55 Required</p>
            </div>
        </div>
    )
}
