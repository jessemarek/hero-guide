    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/cap-of-souls.png" width="36" height="36" /><img src="/assets/images/icons/equipment/gem-of-vigor.png" width="36" height="36" /><br></br><img src="/assets/images/icons/equipment/strand-of-rejuvenation.png" width="36" height="36" /><img src="/assets/images/icons/equipment/spartan-helmet.png" width="36" height="36" /><p>Level 79 Required</p>
            </div>
        </div>
    )
}
