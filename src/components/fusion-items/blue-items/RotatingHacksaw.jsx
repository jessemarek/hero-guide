    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/gem-of-fortitude.png" width="36" height="36" /><img src="/assets/images/icons/equipment/skull-bonnet.png" width="36" height="36" /><p>Level 46 Required</p>
            </div>
        </div>
    )
}
