    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/thorned-pauldrons.png" width="36" height="36" /><img src="/assets/images/icons/equipment/berserker's-claymore.png" width="36" height="36" /><img src="/assets/images/icons/equipment/iron-chainmail.png" width="36" height="36" /><p>Level 43 Required</p>
            </div>
        </div>
    )
}
