    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/lost-epic.png" width="36" height="36" /><img src="/assets/images/icons/equipment/oracle's-robe.png" width="36" height="36" /><img src="/assets/images/icons/equipment/scepter-of-truth.png" width="36" height="36" /><p>Level 99 Required</p>
            </div>
        </div>
    )
}
