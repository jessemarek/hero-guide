    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/staff-of-illumination.png" width="36" height="36" /><img src="/assets/images/icons/equipment/primordial-stone.png" width="36" height="36" /><img src="/assets/images/icons/equipment/ethereal-cloak.png" width="36" height="36" /><p>Level 94 Required</p>
            </div>
        </div>
    )
}
