    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/doomsday-armor.png" width="36" height="36" /><img src="/assets/images/icons/equipment/runic-crystal-ball.png" width="36" height="36" /><img src="/assets/images/icons/equipment/destruction.png" width="36" height="36" /><p>Level 88 Required</p>
            </div>
        </div>
    )
}
