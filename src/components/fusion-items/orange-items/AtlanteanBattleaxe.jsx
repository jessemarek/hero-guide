    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/bandit's-dagger.png" width="36" height="36" /><img src="/assets/images/icons/equipment/ironbark-warbow.png" width="36" height="36" /><img src="/assets/images/icons/equipment/blade-of-chaos.png" width="36" height="36" /><p>Level 91 Required</p>
            </div>
        </div>
    )
}
