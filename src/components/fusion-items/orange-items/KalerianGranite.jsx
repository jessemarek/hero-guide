    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/kretonian-talisman.png" width="36" height="36" /><img src="/assets/images/icons/equipment/primordial-stone.png" width="36" height="36" /><img src="/assets/images/icons/equipment/mystic-dragonscale.png" width="36" height="36" /><p>Level 92 Required</p>
            </div>
        </div>
    )
}
