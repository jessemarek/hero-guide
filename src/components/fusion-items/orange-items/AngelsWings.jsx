    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/healing-stone.png" width="36" height="36" /><img src="/assets/images/icons/equipment/stealth-cape.png" width="36" height="36" /><p>Level 84 Required</p>
            </div>
        </div>
    )
}
