    ...
    return (
        <div className="fusion-item">
            ...
            <div className="tooltip">
                ...
                <h3>Recipe</h3>
                <img src="/assets/images/icons/equipment/grim-slasher.png" width="36" height="36" /><img src="/assets/images/icons/equipment/runic-crystal-ball.png" width="36" height="36" /><br></br><img src="/assets/images/icons/equipment/soul-stealing-necklace.png" width="36" height="36" /><img src="/assets/images/icons/equipment/starfall-wand.png" width="36" height="36" /><p>Level 82 Required</p>
            </div>
        </div>
    )
}
