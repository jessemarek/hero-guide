...
const AwakeningQuest = ({ name, awakening }) => {
  return (
      ...
      <div className="section-body">
        <div className="hero-art">
          <div className="hero-card spoiler-card spoiler-off">
            ...
            <div className="card-face">
              <img
                ...
                alt={`Awakened artwork card for ${formatText(name)}`}
              />
            </div>
          </div>
          ...
          <div className="hero-portrait spoiler-card spoiler-off">
            ...
            <div className="card-face">
              <img
                src={`/assets/images/icons/portraits-aw/${name}-aw.png`}
                alt={`Awakened portrait for ${formatText(name)}`}
              />
            </div>
          </div>
